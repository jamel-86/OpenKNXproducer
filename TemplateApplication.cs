...
partial class TemplateApplication
{
    ...
    private static string ReplaceEtsTag(string iXml, ProcessInclude iInclude)
    {
        ...
        if (lEtsList.Count > 0)
        {
            ...
            InitParam(lParams, "AdditionalAddressesCount", false, "", "");
            ...
            lParams["%AdditionalAddressesAttribute%"] = "";
            if (int.TryParse(lParams["%AdditionalAddressesCount%"], out int lAdditionalAddressesCount) && lAdditionalAddressesCount > 0)
                lParams["%AdditionalAddressesAttribute%"] = $" AdditionalAddressesCount=\"{lAdditionalAddressesCount}\"";
